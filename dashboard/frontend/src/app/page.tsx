...
export default function Dashboard() {
  ...
  return (
    <>
<aside className="fixed inset-y-0 left-0 w-64 bg-white dark:bg-slate-950 flex flex-col h-full py-3 border-r border-outline-variant z-50">
<div className="px-3 mb-4">
<h1 className="text-lg font-black text-secondary font-headline uppercase tracking-tighter">Montgó Horizon</h1>
<p className="text-[10px] uppercase tracking-[0.2em] text-on-surface-variant font-bold mt-0.5">Vigilancia Activa</p>
</div>
<nav className="flex-1 space-y-0.5 px-1.5">
<a className="flex items-center gap-1.5 px-1.5 py-[5px] bg-surface-container text-secondary border-r-4 border-secondary font-bold transition-transform duration-200 hover:translate-x-1" href="#">
<span className="material-symbols-outlined text-xl">dashboard</span>
<span className="text-sm tracking-wide">Resumen</span>
</a>
<a className="flex items-center gap-1.5 px-1.5 py-[5px] text-on-surface-variant hover:bg-surface-container transition-transform duration-200 hover:translate-x-1" href="#">
<span className="material-symbols-outlined text-xl">sensors</span>
<span className="text-sm tracking-wide">Sensores</span>
</a>
<a className="flex items-center gap-1.5 px-1.5 py-[5px] text-on-surface-variant hover:bg-surface-container transition-transform duration-200 hover:translate-x-1" href="#">
<span className="material-symbols-outlined text-xl">videocam</span>
<span className="text-sm tracking-wide">Cámaras</span>
</a>
<a className="flex items-center gap-1.5 px-1.5 py-[5px] text-on-surface-variant hover:bg-surface-container transition-transform duration-200 hover:translate-x-1" href="#">
<span className="material-symbols-outlined text-xl">thermostat</span>
<span className="text-sm tracking-wide">Clima</span>
</a>
<a className="flex items-center gap-1.5 px-1.5 py-[5px] text-on-surface-variant hover:bg-surface-container transition-transform duration-200 hover:translate-x-1" href="#">
<span className="material-symbols-outlined text-xl">warning</span>
<span className="text-sm tracking-wide">Alertas</span>
</a>
</nav>
<div className="px-2 mt-auto">
<div className="mt-3 pt-3 border-t border-outline-variant space-y-0.5">
<a className="flex items-center gap-1.5 px-1.5 py-1 text-on-surface-variant hover:bg-surface-container transition-all rounded-lg" href="#">
...
<h2 className="text-xl font-bold tracking-tight text-secondary">PARQUE NATURAL DEL MONTGÓ</h2>
...
<img alt="Perfil de Despachador" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCWzrpBQl7JSK4V--nDJP-zHtkKTzsBuiNANftBkd3I1w-9g42s8g_noKhXZ2gM0Q1f9ihHnUNDjpSrofJi09zPPSSBXc0V-erSMD0lghR0oPSpIFFPpw_VlHCSSBh_uy0huxOjAH_b5nbJ8w2iWAEV44B9jjTqoDX_TmhU8lrltUZKMaiSlTsLzIqSARQ5yOVH6HyqfmzC-73MENo36p7cvyXOmjWedVGqxpvj1nbfMWAoh7Ga28ERvP2lLwnTf6CotTNWIQr2eWUS"/>
</div>
</div>
</div>
</header>
